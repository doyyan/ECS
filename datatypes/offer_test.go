...
func TestCreateOffers(t *testing.T) {
		...
		for _, test := range tests {
			...
			tf := func(t *testing.T) {
...

				{
					...
					offer := datatypes.CreateOffer(test.datainput.ProductID, test.datainput.ProductName, test.datainput.OfferName, test.datainput.OfferID, test.datainput.MultiBuyDiscount, test.datainput.GroupPromotion)
...
func BenchmarkFCreateOffer(b *testing.B) {
	...
	for n := 0; n < b.N; n++ {
		offer := datatypes.CreateOffer(BakedBeansBuy2Get1Free.ProductID, BakedBeansBuy2Get1Free.ProductName, BakedBeansBuy2Get1Free.OfferName, BakedBeansBuy2Get1Free.OfferID, BakedBeansBuy2Get1Free.MultiBuyDiscount, BakedBeansBuy2Get1Free.GroupPromotion)
		testOffer = offer
